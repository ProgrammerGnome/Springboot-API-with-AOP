package com.jetbrains.kmark7.storages.clone.aspect;
...
public class ServerLog {
    private static final String POINTCUT = "within(com.jetbrains.kmark7.storages.clone.controller.*)";
    @Around(POINTCUT)
    @SneakyThrows
    ...
    private static final String POINTCUT2 = "within(com.jetbrains.kmark7.storages.clone.view.*)";
    @Around(POINTCUT2)
    @SneakyThrows
